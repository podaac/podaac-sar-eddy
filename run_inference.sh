...
tar -xvzf S1A_IW_GRDH_1SDV_20190101T142321_20190101T142346_025285_02CBF8_27F9.tar.gz .
...
conda run -n sar_eddy_env aws s3 cp $output_tar s3://$OUTPUT_BUCKET_NAME/sar_eddy/${SAR_TASK_ID}_outputs.tar.gz --region us-west-2
